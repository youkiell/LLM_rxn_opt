...
class ExistingReactionAgent(BaseAgent):
    name = "existing_reaction_agent"

    def __init__(self, config):
        self.prompt = load_prompt("existing_reaction_agent")
        self.llm = LLMClient(
